        ...
        if(campArray.isEmpty()){
            ...
            if(!onlyYourOwn){
                for(int i=1; i< campArray.size()+1; i++){
                    if(campArray.get(i).getVisiblility() == Camp.visibilityStatus.NOVISIBILE){
                        System.out.println("Camp Number "+i+" on display! Visible to: Staff Only!");
                    }
                    else if(campArray.get(i).getVisiblility() == Camp.visibilityStatus.FACULTY){
                        System.out.println("Camp Number "+i+" on display! Visible to: Staff and students in cookie of campstaff faculty!");
                    }else if(campArray.get(i).getVisiblility() == Camp.visibilityStatus.ENTIRESCHOOL){
