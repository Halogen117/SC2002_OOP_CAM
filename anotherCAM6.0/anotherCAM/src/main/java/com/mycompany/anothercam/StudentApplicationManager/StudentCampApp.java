        ...
        while(loopCamp){
            ...
            switch(chooseCamp){
                ...
                case 1:
                    ...
                    studView.runStudentViewCamp(campArray, (Student) cookie, scanObj);
                    break;
                
                case 2:
                    StudentCampRegister studReg = new StudentCampRegister();
                    studReg.runStudentRegister(campArray,(Student) cookie, scanObj);
                    break;

                case 3:
                    StudentCampUnregister studUnReg = new StudentCampUnregister();
                    studUnReg.runUnregister(campArray, (Student) cookie, scanObj);
                    break;
            }
        }
        return true;
