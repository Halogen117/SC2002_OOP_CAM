...
public abstract class User {
    ...
    */
    ...
    /**
    * Gets the status of whether of the User Object of they logged in already.
    * @return the boolean variable if logged in of the User Object.
    */
    ...
    */
    ...
    /**
    * Changes the boolean of the firstLogin of the User Object
    * @param firstLogin This user new firstLogin should just be a regular boolean in general.
    *                The validation is already done before the method is called.
    */
