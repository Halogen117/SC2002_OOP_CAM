...
public class Camp {
    ...
    */
    public Camp(int campID, String campName, LocalDateTime date,LocalDateTime regClosingDate, String location, int totalSlot, int campCommitteeSlots, String description, String staffInCharge, visibilityStatus visiblility, String faculty){
        this.campID = campID;
    ...
    */
    public void addStudentToList(Student stud){
        ...
        System.out.println("The number of Total Attendees in the list is now "+this.studentList.size());
    }
    ...
    */
    public void addCampCommitteeMemberToList(Student stud){
        ...
        System.out.println("The number of Camp Committee members in the list is now "+this.campCommitteeList.size());
    }
